...
class TestAirportTaxi:
    def test_airport_taxi_one_way(self, driver_undetected):
        ...
        with soft_assertions():
            assert_that(airport_taxi.current_url_is_contain("https://www.booking.com/index")).is_true()
        ...
        with soft_assertions():
            assert_that(airport_taxi.current_url_is_contain("https://www.booking.com/taxi")).is_true()
        ...
        with soft_assertions():
            assert_that(airport_taxi.current_url_is_contain("https://taxis.booking.com/search")).is_true()
        ...
        with soft_assertions():
            assert_that(airport_taxi_details.current_url_is_contain("https://taxis.booking.com/checkout")).is_true()
